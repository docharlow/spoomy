...
class TxnMallTest(SpoomyTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 SPY:
        ...
        # First: use raw transaction API to send 12400 SPY to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 SPY coin each
        ...
        # Node0's balance should be starting balance, plus 500 SPY for another
        ...
        # Node0's total balance should be starting balance, plus 1000 SPY for
