...
#ifndef ZUMY_GOVERNANCE_CLASSES_H
#define ZUMY_GOVERNANCE_CLASSES_H

//#define ENABLE_ZUMY_DEBUG
...
static const CAmount STATIC_SUPERBLOCK_AMOUNT = 0 * COIN; //Budget amount fixed at 0 SPY
...
public:
    ...
    CGovernancePayment(CSpoomyAddress addrIn, CAmount nAmountIn)
        :fValid(false),
         script(),
         nAmount(0)
    {
...
#endif // ZUMY_GOVERNANCE_CLASSES_H
