...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Spoomy features */
    { "Spoomy",                "masternode",                 &masternode,                 true  },
    { "Spoomy",                "masternodelist",             &masternodelist,             true  },
    { "Spoomy",                "masternodebroadcast",        &masternodebroadcast,        true  },
    { "Spoomy",                "gobject",                &gobject,                true  },
    { "Spoomy",                "getgovernanceinfo",      &getgovernanceinfo,      true  },
    { "Spoomy",                "getsuperblockbudget",    &getsuperblockbudget,    true  },
    { "Spoomy",                "voteraw",                &voteraw,                true  },
    { "Spoomy",                "mnsync",                 &mnsync,                 true  },
    { "Spoomy",                "spork",                  &spork,                  true  },
    { "Spoomy",                "getpoolinfo",            &getpoolinfo,            true  },
#ifdef ENABLE_WALLET
    { "Spoomy",                "privatesend",            &privatesend,            false },
...
{
    return "> spoomy-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleRpc(const std::string& methodname, const std::string& args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
        "\"method\": \"" + methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31051/\n";
}
