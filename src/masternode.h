...
#ifndef ZUMY_MASTERNODE_H
#define ZUMY_MASTERNODE_H
...
//
// The Masternode Class. For managing the Privatesend process. It contains the input of the 1000SPY, signature to prove
...
public:
    ...
    /// Is the input associated with this public key? (and there is 500 SPY (5,000 after fork) - checking if valid Masternode)
