...
#ifndef ZUMY_WALLET_WALLET_H
#define ZUMY_WALLET_WALLET_H
...
public:
    ...
    /// Get 500 SPY (5,000 after fork) output and keys which can be used for the Masternode
