...
2. run spoomyd with -printalert or -sendalert like this:
   /path/to/spoomyd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.github.com/spoomy-zmy/spoomy";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Spoomy:1.0.0.0/"));
