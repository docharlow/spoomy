...
UniValue gobject(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by Masternode configured in spoomy.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("spoomy.conf", statusObj));
...
UniValue voteraw(const UniValue& params, bool fHelp)
{
    ...
    uint256 hashMnTx = ParseHashV(params[0], "Masternode tx hash");
