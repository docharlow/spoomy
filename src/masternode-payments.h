...
#ifndef ZUMY_MASTERNODE_PAYMENTS_H
#define ZUMY_MASTERNODE_PAYMENTS_H
...
static const int MIN_MASTERNODE_PAYMENT_PROTO_VERSION = 70000;
...
#endif // ZUMY_MASTERNODE_PAYMENTS_H
