...
public:
    ...
    void SelfTest() const
    {
        // Manually recompute the spoomy usage of the whole data, and compare it.
        size_t ret = memusage::SpoomyUsage(cacheCoins);
        for (CCoinsMap::iterator it = cacheCoins.begin(); it != cacheCoins.end(); it++) {
            ret += it->second.coins.SpoomyMemoryUsage();
        }
        BOOST_CHECK_EQUAL(SpoomyMemoryUsage(), ret);
    }
