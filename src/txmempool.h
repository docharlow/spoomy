...
#ifndef ZUMY_TXMEMPOOL_H
#define ZUMY_TXMEMPOOL_H
...
public:
    ...
    size_t SpoomyMemoryUsage() const { return nUsageSize; }
...
private:
    ...
    uint64_t cachedInnerUsage; //! sum of spoomy memory usage of all the map elements (NOT the maps themselves)
...
public:
    ...
    /** Remove transactions from the mempool until its spoomy size is <= sizelimit.
    ...
    size_t SpoomyMemoryUsage() const;
