...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 40; // Masternode Payments begin on block 10800 .
        consensus.nInstantSendKeepLock = 24;
        consensus.nBudgetPaymentsStartBlock = 20545; // Spoomy doesn't use budget payments.
        ...
        consensus.nSuperblockStartBlock = 20546; // Spoomy doesn't have superblocks.
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Spoomy: 24 hours
        consensus.nPowTargetSpacing = 2 * 64; // Spoomy: 128 seconds
        consensus.nPowMaxAdjustDown = 32; // Spoomy: 32% adjustment down
        consensus.nPowMaxAdjustUp = 16; // Spoomy: 16% adjustment up
        ...
        // Spoomy addresses start with 'Z'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,80);
        // Spoomy script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Spoomy private keys start with 'y'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,140);
        // Spoomy BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Spoomy BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Spoomy BIP44 coin type is '5'
        nExtCoinType = 5;
	...
	consensus.nSpoomyBeginsBlock =  4;
...
public:
    CTestNetParams() {
        ...
        consensus.nPowAveragingWindow = 17;
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Spoomy: 24 hours
        consensus.nPowTargetSpacing = 10; // Spoomy Testnet: 10 seconds
        consensus.nPowMaxAdjustDown = 32; // Spoomy: 32% adjustment down
        consensus.nPowMaxAdjustUp = 16; // Spoomy: 16% adjustment up
        assert(maxUint/UintToArith256(consensus.powLimit) >= consensus.nPowAveragingWindow);
        ...
        // Testnet Spoomy addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Testnet Spoomy script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,10);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,158);
        // Testnet Spoomy BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Spoomy BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Spoomy BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Spoomy: 24 hours
        consensus.nPowTargetSpacing = 2 * 64; // Spoomy: 256 seconds
        consensus.nPowMaxAdjustDown = 32; // Spoomy: 32% adjustment down
        consensus.nPowMaxAdjustUp = 16; // Spoomy: 16% adjustment up
        assert(maxUint/UintToArith256(consensus.powLimit) >= consensus.nPowAveragingWindow);
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        // Regtest Spoomy addresses start with 'C'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest Spoomy script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Spoomy BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Spoomy BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Regtest Spoomy BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
