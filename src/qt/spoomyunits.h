...
#ifndef ZUMY_QT_ZUMYUNITS_H
#define ZUMY_QT_ZUMYUNITS_H
...
/** Spoomy unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SpoomyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SpoomyUnits(QObject *parent);
...
typedef SpoomyUnits::Unit SpoomyUnit;

#endif // ZUMY_QT_ZUMYUNITS_H
