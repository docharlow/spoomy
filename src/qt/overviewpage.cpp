...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle):
        QAbstractItemDelegate(), unit(SpoomyUnits::SPY),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = SpoomyUnits::floorWithUnit(unit, amount, true, SpoomyUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, SpoomyUnits::separatorAlways));
    ui->labelUnconfirmed->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, SpoomyUnits::separatorAlways));
    ui->labelImmature->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, SpoomyUnits::separatorAlways));
    ui->labelAnonymized->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, SpoomyUnits::separatorAlways));
    ui->labelTotal->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, SpoomyUnits::separatorAlways));
    ui->labelWatchAvailable->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, SpoomyUnits::separatorAlways));
    ui->labelWatchPending->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, SpoomyUnits::separatorAlways));
    ui->labelWatchImmature->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, SpoomyUnits::separatorAlways));
    ui->labelWatchTotal->setText(SpoomyUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, SpoomyUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("SPY")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = SpoomyUnits::formatHtmlWithUnit(nDisplayUnit, nPrivateSendAmount * COIN, false, SpoomyUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), SpoomyUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = SpoomyUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, SpoomyUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), SpoomyUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(SpoomyUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(SpoomyUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
