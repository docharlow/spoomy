...
#include "config/spoomy-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatSpoomyURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + SpoomyUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatSpoomyURI(info));
}
