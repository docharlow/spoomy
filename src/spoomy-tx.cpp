...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Spoomy spoomy-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  spoomy-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spoomy transaction") + "\n" +
              "  spoomy-tx [options] -create [commands]   " + _("Create hex-encoded spoomy transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded spoomy transaction
